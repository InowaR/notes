...
from view.commands.find_note_by_title import FindNoteByTitle
...
class Menu():
    def __init__(self):
        ...
        self.commands_main_menu.append(FindNoteByTitle(self.presenter))
        ...
        self.commands_main_menu.append(DeleteNote(self.presenter))
